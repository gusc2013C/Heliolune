...
| Parallel reads | Conditional 4-way default when Sol finds at least two independent workstreams. | A natural built-in fit and usually the simpler choice when cost instrumentation is not required. |
